...
pretty:
	$(COMPILER) src/main_pretty.c src/trek.c src/dialservice.c src/voiceserver.c src/addressbook.c src/call.c src/connection.c src/audio.c src/lfqueue.c src/lfringbuffer.c src/keypad.c libportaudio.a -I$(CURDIR) -g -std=c99 -D _POSIX_C_SOURCE=200809L -o pretty $(LFLAGS)
